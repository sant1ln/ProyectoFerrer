...
function obtenerProductos(){
    ...
    try{
        return $conn->query("SELECT Id_Producto, Nombre_Producto, Id_Tipo_Producto, Precio_Venta FROM producto");
...
function obtenerInventario(){
    ...
    try {
               $sql = "SELECT Id_Producto, Id_Tipo_Producto, Nombre_Producto, Precio_Venta, SUM(Cantidad_Producto) as existencia ";
...
function obtenerProducto($id){
    ...
    try{
        return $conn->query("SELECT Id_Producto, Nombre_Producto, Id_Tipo_Producto, Precio_Venta FROM producto WHERE Id_Producto = $id");
